    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        if (typeof gsap !== typeof undefined) {
            ...
            if (jQuery('#home-1').length) {
                ...
                home1.from('#banner-title', {
                    y: 50
                })
                home1.from('#banner-description', {
                    y: 50
                })
                home1.from('#banner-action', {
                    y: 50
                })
                home1.from('#banner-image-bg', {
                    scale: .9
                })
                home1.from('#banner-image', {
                    scale: .9
                })
                gsap.from('.slider-2', {
                    opacity: 0,
            ...
            Array.from(animatedButton, (elem) => {
                ...
                t1.to(elem.querySelectorAll('.anim'), {
                    y: -4,
                    stagger: {
                        each: .1,
                        repeat: 1,
